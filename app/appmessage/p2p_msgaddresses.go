...
// Kalibrium Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a Kalibrium
// Addresses message.
...
// NewMsgAddresses returns a new Kalibrium Addresses message that conforms to the
