...
// MsgBlockLocator implements the Message interface and represents a Kalibrium
...
// NewMsgBlockLocator returns a new Kalibrium locator message that conforms to
