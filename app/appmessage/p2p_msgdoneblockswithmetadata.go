...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a Kalibrium
...
// NewMsgDoneBlocksWithTrustedData returns a new Kalibrium DoneBlocksWithTrustedData message that conforms to the
// Message interface.
