...
// MsgDoneHeaders implements the Message interface and represents a Kalibrium
...
// NewMsgDoneHeaders returns a new Kalibrium DoneIBDBlocks message that conforms to the
// Message interface.
