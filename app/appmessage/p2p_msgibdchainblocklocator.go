...
// MsgIBDChainBlockLocator implements the Message interface and represents a Kalibrium
...
// NewMsgIBDChainBlockLocator returns a new Kalibrium locator message that conforms to
