...
// MsgInvTransaction implements the Message interface and represents a Kalibrium
...
// NewMsgInvTransaction returns a new Kalibrium TxInv message that conforms to
