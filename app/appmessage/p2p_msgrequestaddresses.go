...
// MsgRequestAddresses implements the Message interface and represents a Kalibrium
...
// NewMsgRequestAddresses returns a new Kalibrium RequestAddresses message that conforms to the
