...
// MsgRequestHeaders implements the Message interface and represents a Kalibrium
...
// NewMsgRequstHeaders returns a new Kalibrium RequestHeaders message that conforms to the
