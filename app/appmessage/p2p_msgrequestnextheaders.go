...
// MsgRequestNextHeaders implements the Message interface and represents a Kalibrium
...
// NewMsgRequestNextHeaders returns a new Kalibrium RequestNextHeaders message that conforms to the
// Message interface.
