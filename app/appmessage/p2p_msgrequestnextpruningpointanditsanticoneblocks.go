...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a Kalibrium
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new Kalibrium RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
