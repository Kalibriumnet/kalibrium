...
// MsgRequestRelayBlocks implements the Message interface and represents a Kalibrium
...
// NewMsgRequestRelayBlocks returns a new Kalibrium RequestRelayBlocks message that conforms to
