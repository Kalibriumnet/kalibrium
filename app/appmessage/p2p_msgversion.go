...
var DefaultUserAgent = fmt.Sprintf("/Kalibrium:%s/", version.Version())

// MsgVersion implements the Message interface and represents a Kalibrium version
...
// NewMsgVersion returns a new Kalibrium version message that conforms to the
