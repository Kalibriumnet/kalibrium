...
// RPCTransaction is a Kalibrium transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a Kalibrium transaction input representation
...
// RPCScriptPublicKey is a Kalibrium ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a Kalibrium transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a Kalibrium outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a Kalibrium utxo entry representation meant to be used
// over RPC
