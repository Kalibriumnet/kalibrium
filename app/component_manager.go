...
// Start launches all the Kalibrium services.
...
// Stop gracefully shuts down all the Kalibrium services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Kalibrium is already in the process of shutting down")
		return
	}

	log.Warnf("Kalibrium shutting down")
