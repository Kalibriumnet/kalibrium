...
func parseCommand(args []string, commandDescs []*commandDescription) (*protowire.KalibriumdMessage, error) {
	...
	return generateKalibriumdMessage(commandValue, commandDesc)
}
