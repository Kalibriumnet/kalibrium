...
var keyChains = []uint8{libkalibriumwallet.ExternalKeychain, libkalibriumwallet.InternalKeychain}
...
func (s *server) updateAddressesAndLastUsedIndexes(requestedAddressSet walletAddressSet,
	...
	for _, entry := range getBalancesByAddressesResponse.Entries {
		...
		if walletAddress.keyChain == libkalibriumwallet.ExternalKeychain {
