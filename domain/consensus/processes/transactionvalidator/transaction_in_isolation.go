...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a equil. One Kalibrium is a quantity of equil as defined by the
	// equilPerKalibrium constant.
	var totalEquil uint64
