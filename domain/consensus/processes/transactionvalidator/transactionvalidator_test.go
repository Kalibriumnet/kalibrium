...
func TestValidateTransactionInContextAndPopulateFee(t *testing.T) {
	testutils.ForAllNets(t, true, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		tests := []struct {
			...
			{ // The total inputs amount is bigger than the allowed maximum (constants.MaxEquil)
			...
			{ // The total EquilIn (sum of inputs amount) is smaller than the total EquilOut (sum of outputs value) and hence invalid.
