...
Kalibrium transaction scripts.

# Script Overview

Kalibrium transaction scripts are written in a stack-base, FORTH-like language.

The Kalibrium script language consists of a number of opcodes which fall into
...
Typical Kalibrium scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend Kalibrium.
