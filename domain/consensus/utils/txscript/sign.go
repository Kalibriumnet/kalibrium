...
// SignatureScript creates an input signature script for tx to spend KALI sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend KALI sent
