...
var genesisTxPayload = []byte{
	...
	0x01,                                           // Varint
	0x00,                                           // OP-FALSE
	0xd7, 0x95, 0xd7, 0x9e, 0xd7, 0x94, 0x20, 0xd7, // "This is it, baby. Hold me." - Sgt Johnson, UNSC Marine Corps, Halo Combat Evolved.
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Bitcoin block hash 000000000000000000004119de1481f6d049072f15878c46ab572b2cb34fe1a8
	0x00, 0x0b, 0x1f, 0x8e, 0x1c, 0x17, 0xb0, 0x13,
	0x3d, 0x43, 0x91, 0x74, 0xe5, 0x2e, 0xfb, 0xb0,
	0xc4, 0x1c, 0x35, 0x83, 0xa8, 0xaa, 0x66, 0xb0,
	0x0b, 0xca, 0x37, 0xca, 0x16, 0x1c, 0x4d, 0xba, // UTXO
	0x0a, 0x6c, 0x44, 0x11, 0xda, 0xd9, 0x41, 0xC7,
	0x50, 0x91, 0x61, 0x10, 0xc4, 0x24, 0xaf, 0xA4,
	0xdb, 0xeb, 0xc4, 0x12, 0xab, 0x13, 0xae, 0xD5,
}
...
var genesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x52, 0xb1, 0xa4, 0x19, 0x9e, 0x21, 0xf5, 0x90, 0xd1, 0x54, 0x1a, 0x11, 0x49, 0x69, 0xde, 0xce, 0xf4, 0x8f, 0x9, 0xf9, 0x34, 0xd4, 0x2c, 0xcb, 0x6a, 0x28, 0x1a, 0x12, 0x84, 0x2f, 0x19, 0x79,
})

// genesisMerkleRoot is the hash of the first transaction in the genesis block
// for the main network.
var genesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x2e, 0xc1, 0x98, 0x76, 0x5c, 0x64, 0x1, 0xb1, 0x3a, 0xc4, 0xee, 0x6d, 0x1a, 0x4b, 0x24, 0xb6, 0xe6, 0x22, 0x6b, 0x63, 0x2f, 0x20, 0x85, 0x4f, 0x5, 0x30, 0x64, 0x10, 0x71, 0x6e, 0xeb, 0x32,
})
...
var genesisBlock = externalapi.DomainBlock{
	Header: blockheader.NewImmutableBlockHeader(
		...
		externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
			0x89, 0x0A, 0x27, 0xdc, 0x41, 0x5e, 0x63, 0xab, 0x6c, 0xbb, 0x62, 0xb8, 0x9e, 0xa5, 0xa0, 0x6c, 0xff, 0xa3, 0x91, 0xd7, 0x6f, 0x16, 0x77, 0x04, 0x45, 0x5b, 0x5a, 0xf5, 0x9d, 0xef, 0x8e, 0x20,
		}),
		1707609671037,
		482721099,
		0x3122b,
...
var devnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // Kalibrium-devnet
}
...
var devnetGenesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x58, 0xab, 0xf2, 0x03, 0x22, 0xd7, 0x07, 0x18,
	0x16, 0x2b, 0x6b, 0xf8, 0xa9, 0xf5, 0x49, 0xba,
	0x33, 0xae, 0x6e, 0x32, 0xb3, 0xb1, 0x4a, 0xdb,
	0x7f, 0xa6, 0x5d, 0x11, 0x41, 0xa3, 0xf1, 0x2d,
})
...
var simnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // Kalibrium-simnet
}
...
var simnetGenesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x41, 0x1f, 0x9c, 0xd2, 0x6f, 0x3d, 0x41, 0xde,
	0xa3, 0x1e, 0x78, 0x57, 0x29, 0x27, 0xda, 0x24,
	0xd2, 0x39, 0x65, 0x70, 0x7b, 0x57, 0x9f, 0x40,
	0x95, 0x4b, 0x91, 0x27, 0xe9, 0x6b, 0x79, 0xe6,
})

// simnetGenesisMerkleRoot is the hash of the first transaction in the genesis block
// for the devopment network.
var simnetGenesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x19, 0x46, 0xa6, 0x29, 0xf7, 0xe9, 0x22, 0xa7,
	0xbc, 0xed, 0x59, 0x16, 0x05, 0x21, 0xc3, 0x27,
...
var testnetGenesisTxPayload = []byte{
	...
	0x01,                                                                         // Varint
	0x00,                                                                         // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, // Kalibrium-testnet
}
