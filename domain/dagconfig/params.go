...
import (
	...
	"github.com/kalibriumnet/kalibrium/util/network"
...
// Params defines a Kalibrium network by its parameters. These parameters may be
// used by Kalibrium applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/Kalibrium-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/kalibriumnet/research/issues/3
...
// MainnetParams defines the network parameters for the main Kalibrium network.
var MainnetParams = Params{
	...
	Prefix: util.Bech32PrefixKalibrium,
...
// TestnetParams defines the network parameters for the test Kalibrium network.
var TestnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixKalibriumTest,
...
// SimnetParams defines the network parameters for the simulation test Kalibrium
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixKalibriumSim,
...
// DevnetParams defines the network parameters for the development Kalibrium network.
var DevnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "Kalibrium-devnet",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixKalibriumDev,
...
// ErrDuplicateNet describes an error where the parameters for a Kalibrium
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Kalibrium network")

var registeredNets = make(map[appmessage.KalibriumNet]struct{})

// Register registers the network parameters for a Kalibrium network. This may
