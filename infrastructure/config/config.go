...
const (
	defaultConfigFilename      = "Kalibrium.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "Kalibrium.log"
	defaultErrLogFilename      = "kalibriumd_err.log"
	...
	defaultMinRelayTxFee         = 1e-5 // 1 equil per byte
...
var (
	// DefaultAppDir is the default home directory for Kalibrium.
	DefaultAppDir = util.AppDir("Kalibrium", false)
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 19421, testnet: 16211)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 19420, testnet: 19510)"`
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in KALI/kB to be considered a non-zero fee."`
...
//
// The above results in Kalibrium functioning properly without any config settings
