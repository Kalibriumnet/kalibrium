...
type grpcStream interface {
	Send(*protowire.KalibriumdMessage) error
	Recv() (*protowire.KalibriumdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.KalibriumdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.KalibriumdMessage) error {
