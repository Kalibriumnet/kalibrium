...
type P2P_MessageStreamClient interface {
	Send(*KalibriumdMessage) error
	Recv() (*KalibriumdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *KalibriumdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*KalibriumdMessage, error) {
	m := new(KalibriumdMessage)
...
func (x *p2PMessageStreamServer) Send(m *KalibriumdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*KalibriumdMessage, error) {
	m := new(KalibriumdMessage)
...
func (x *rPCMessageStreamClient) Send(m *KalibriumdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*KalibriumdMessage, error) {
	m := new(KalibriumdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *KalibriumdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*KalibriumdMessage, error) {
	m := new(KalibriumdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
