...
func (x *KalibriumdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "KalibriumdMessage_Addresses is nil")
	}
...
func (x *KalibriumdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
