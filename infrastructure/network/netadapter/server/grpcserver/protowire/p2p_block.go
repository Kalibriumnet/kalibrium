...
func (x *KalibriumdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "KalibriumdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *KalibriumdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
