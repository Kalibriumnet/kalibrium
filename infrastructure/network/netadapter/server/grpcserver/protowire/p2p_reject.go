...
func (x *KalibriumdMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_Reject is nil")
	}
...
func (x *KalibriumdMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
