...
func (x *KalibriumdMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *KalibriumdMessage_RequestPruningPointUTXOSet) fromAppMessage(
