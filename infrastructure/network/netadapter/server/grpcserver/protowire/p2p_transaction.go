...
func (x *KalibriumdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *KalibriumdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
