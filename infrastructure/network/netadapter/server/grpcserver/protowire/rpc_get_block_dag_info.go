...
func (x *KalibriumdMessage_GetBlockDagInfoRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_GetBlockDagInfoRequest is nil")
	}
	return &appmessage.GetBlockDAGInfoRequestMessage{}, nil
}

func (x *KalibriumdMessage_GetBlockDagInfoRequest) fromAppMessage(_ *appmessage.GetBlockDAGInfoRequestMessage) error {
	x.GetBlockDagInfoRequest = &GetBlockDagInfoRequestMessage{}
	return nil
}

func (x *KalibriumdMessage_GetBlockDagInfoResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_GetBlockDagInfoResponse is nil")
	}
...
func (x *KalibriumdMessage_GetBlockDagInfoResponse) fromAppMessage(message *appmessage.GetBlockDAGInfoResponseMessage) error {
	var err *RPCError
