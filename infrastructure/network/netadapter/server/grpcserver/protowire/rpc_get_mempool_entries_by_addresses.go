...
func (x *KalibriumdMessage_GetMempoolEntriesByAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_KalibriumdMessage_GetMempoolEntriesByAddressesRequest is nil")
	}
	return x.GetMempoolEntriesByAddressesRequest.toAppMessage()
}

func (x *KalibriumdMessage_GetMempoolEntriesByAddressesRequest) fromAppMessage(message *appmessage.GetMempoolEntriesByAddressesRequestMessage) error {
...
func (x *GetMempoolEntriesByAddressesRequestMessage) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_GetMempoolEntriesRequest is nil")
	}
...
func (x *KalibriumdMessage_GetMempoolEntriesByAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_GetMempoolEntriesByAddressesResponse is nil")
	}
	return x.GetMempoolEntriesByAddressesResponse.toAppMessage()
}

func (x *KalibriumdMessage_GetMempoolEntriesByAddressesResponse) fromAppMessage(message *appmessage.GetMempoolEntriesByAddressesResponseMessage) error {
	var rpcErr *RPCError
