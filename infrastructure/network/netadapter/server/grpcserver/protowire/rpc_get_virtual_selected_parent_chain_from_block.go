...
func (x *KalibriumdMessage_GetVirtualSelectedParentChainFromBlockRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_GetVirtualSelectedParentChainFromBlockRequest is nil")
	}
	return x.GetVirtualSelectedParentChainFromBlockRequest.toAppMessage()
}

func (x *KalibriumdMessage_GetVirtualSelectedParentChainFromBlockRequest) fromAppMessage(message *appmessage.GetVirtualSelectedParentChainFromBlockRequestMessage) error {
...
func (x *KalibriumdMessage_GetVirtualSelectedParentChainFromBlockResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KalibriumdMessage_GetVirtualSelectedParentChainFromBlockResponse is nil")
	}
	return x.GetVirtualSelectedParentChainFromBlockResponse.toAppMessage()
}

func (x *KalibriumdMessage_GetVirtualSelectedParentChainFromBlockResponse) fromAppMessage(message *appmessage.GetVirtualSelectedParentChainFromBlockResponseMessage) error {
	var err *RPCError
