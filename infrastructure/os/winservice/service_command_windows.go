...
// installService attempts to install the Kalibrium service. Typically this should
...
// removeService attempts to uninstall the Kalibrium service. Typically this should
...
// startService attempts to Start the Kalibrium service.
