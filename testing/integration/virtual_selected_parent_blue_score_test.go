...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := Kalibrium.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = Kalibrium.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = Kalibrium.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
