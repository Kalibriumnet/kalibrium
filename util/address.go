...
const (
	...
	Bech32PrefixKalibrium

	// Prefix for the dev network.
	Bech32PrefixKalibriumDev

	// Prefix for the test network.
	Bech32PrefixKalibriumTest

	// Prefix for the simulation network.
	Bech32PrefixKalibriumSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"Kalibrium":     Bech32PrefixKalibrium,
	"kalibriumdev":  Bech32PrefixKalibriumDev,
	"kalibriumtest": Bech32PrefixKalibriumTest,
	"kalibriumsim":  Bech32PrefixKalibriumSim,
}
...
// and a payload which encodes the Kalibrium network and address type. It is used
...
// with the passed Kalibrium network.
