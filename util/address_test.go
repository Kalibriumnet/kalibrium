...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "Kalibrium:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			encoded: "Kalibrium:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixKalibrium,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixKalibrium)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixKalibrium,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "Kalibrium:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "Kalibrium:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixKalibrium,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixKalibrium,
			expectedPrefix: util.Bech32PrefixKalibrium,
		},
		{
			name:    "testnet p2pk",
			addr:    "kalibriumtest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			encoded: "kalibriumtest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixKalibriumTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixKalibriumTest)
			},
			passedPrefix:   util.Bech32PrefixKalibriumTest,
			expectedPrefix: util.Bech32PrefixKalibriumTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "Kalibrium:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			encoded: "Kalibrium:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			valid:   true,
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixKalibrium)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixKalibrium,
		},
		...
		},
		{
			...
			addr:           "Kalibrium:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixKalibrium,
			expectedPrefix: util.Bech32PrefixKalibrium,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "Kalibrium:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "Kalibrium:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixKalibrium)
			},
			passedPrefix:   util.Bech32PrefixKalibrium,
			expectedPrefix: util.Bech32PrefixKalibrium,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "Kalibrium:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "Kalibrium:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixKalibrium,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixKalibrium)
			},
			passedPrefix:   util.Bech32PrefixKalibrium,
			expectedPrefix: util.Bech32PrefixKalibrium,
		},
		{
			name:    "testnet p2sh",
			addr:    "kalibriumtest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			encoded: "kalibriumtest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixKalibriumTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixKalibriumTest)
			},
			passedPrefix:   util.Bech32PrefixKalibriumTest,
			expectedPrefix: util.Bech32PrefixKalibriumTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"kalibriumsim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
			util.Bech32PrefixKalibriumSim,
			"unknown address type",
		},
		{
			"kalibriumsim:raskzcg58mth0an",
			util.Bech32PrefixKalibriumSim,
			"unknown address type",
		},
		{
			"kalibriumtest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixKalibrium,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"Kalibrium", util.Bech32PrefixKalibrium, false},
		{"kalibriumtest", util.Bech32PrefixKalibriumTest, false},
		{"kalibriumsim", util.Bech32PrefixKalibriumSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixKalibrium, "Kalibrium"},
		{util.Bech32PrefixKalibriumTest, "kalibriumtest"},
		{util.Bech32PrefixKalibriumSim, "kalibriumsim"},
		{util.Bech32PrefixUnknown, ""},
	}
